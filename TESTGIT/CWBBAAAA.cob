      ...
      *                                                                *
      *  THIS PROGRAM IS THaaazeaE COBOL DEMO PROGRAM USED FOR XPEDITER/TSO  *
      *  TRAINING SESSIONS.                                            *
      *                                                                *
      *  INPUT FILE  - EMPLOYEE WAGE eיNFORMATION                        *
      ...
      ******************************************************************
       ...
       01  CWXTSUBC PIC X(8) VALUE 'CWXTSUBC'.
       01  CWXTDATE PIC X(8) VALUE 'CWXTDATE'.
       01  SWITCHES.
       ...
       01  DATE-FIELDS REDEFINES TODAYS-DATE.
           ...
           05  DATE-DD                PIC 9(2).
      **
      **  HOLD EMP OYEE DETAIL PRINT LINES UNTIL READY TO PRINT
      ...
      * montant de la prime calculיe pour l'assurי
      ...
      ***
       01   IND    PIC S9(8) COMP VALUE 0.

       01  TRUC-LONG.
               05 OCTET PIC X(2) OCCURS 10000.
      ***  REGIONAL SALES REPORT
      ***
      ...
      ***
       01 FILLER pic x(5000) value 'ABC'.

      * DESCRIPTION DE LA TABLE PAYS UHT0AR01

       LINKAGE SECTION.
      * Parametres de linkage
      * Longueur + code type traitement.
       01  PARMINFO.
      ...
      ***
       2000-PROCESS-HOURLY.
           ...
           IF WA-EMP-HOURS GREATER THAN 40
               ...
               MOVE WA-EMP-CITY TO WA-EMP-HIRE-DATE
      ...
      *             MOVE PARM-DATE TO START-NUMBER
                   MOVE START-NUMBER TO PARM-DATA
